...
@Component({
  selector: 'app-acheter-bureaux',
  templateUrl: './acheter-bureaux.component.html',
  styleUrls: ['./acheter-bureaux.component.css']
})
export class AcheterBureauxComponent implements OnInit {
...
this.proporties= data;
  ...
  getterrain(index){
    if(this.proporties[index].category=="bureau" && this.proporties[index].specification=="Vente"){
    return true;
    }
    else{ 
    return false;

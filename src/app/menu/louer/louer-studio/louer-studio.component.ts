...
@Component({
  selector: 'app-louer-studio',
  templateUrl: './louer-studio.component.html',
  styleUrls: ['./louer-studio.component.css']
})
export class LouerStudioComponent implements OnInit {
...
this.proporties= data;
  ...
  getterrain(index){
    if(this.proporties[index].category=="studio" && this.proporties[index].specification=="Location"){
    return true;
    }
    else{ 
    return false;

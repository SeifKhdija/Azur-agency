...
@Component({
  selector: 'app-louer-immeuble',
  templateUrl: './louer-immeuble.component.html',
  styleUrls: ['./louer-immeuble.component.css']
})
export class LouerImmeubleComponent implements OnInit {
...
this.proporties= data;
  ...
  getterrain(index){
    if(this.proporties[index].category=="Immeuble" && this.proporties[index].specification=="Location"){
    return true;
    }
    else{ 
    return false;
